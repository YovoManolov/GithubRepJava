...
class SobelDemoRun {
    ...
    public void run(String[] args) {
		...
		/*
		 * if (args.length == 0){ System.out.println("Not enough parameters!");
		 * System.out.println("Program Arguments: [image_path]"); System.exit(-1); }
		 */
        ...
        Imgproc.threshold(grad, dst, 50, 255, Imgproc.THRESH_BINARY);
        Imgcodecs.imwrite("resources\\result.jpg", dst);
