...
public class AddNewAppointment extends javax.swing.JFrame {
    ...
    private Appointment setAppointment(){
        ...
        TypeOfAppointments  typeOfApp ; 
        
        if(meetingCheckBox.isSelected()){
            typeOfApp = TypeOfAppointments.meeting;
        }else typeOfApp = TypeOfAppointments.task;
        
        
        if(typeOfApp == null){
            m.setMessage("typeOfApp was not initiated ");
            m.setVisible(true);
        }
    ...
    private void saveAppToMap() {
        ...
        m.setMessage("Number of App added to HashMap : "
                + wwhm.mapOfAppointments.size());
        m.setVisible(true);
    }
